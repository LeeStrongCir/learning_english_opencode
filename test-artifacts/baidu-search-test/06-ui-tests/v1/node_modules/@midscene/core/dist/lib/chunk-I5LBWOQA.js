"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }// src/ai-model/service-caller/index.ts
...
function fillBboxParam(locate, width, height) {
  ...
  if (_optionalChain([locate, 'optionalAccess', _2 => _2.bbox])) {
...
function adaptBbox(bbox, width, height) {
  if (_env.vlLocateMode.call(void 0, ) === "doubao-vision" || _env.vlLocateMode.call(void 0, ) === "vlm-ui-tars") {
    return adaptDoubaoBbox(bbox, width, height);
  }
  if (_env.vlLocateMode.call(void 0, ) === "gemini") {
...
function warnGPT4oSizeLimit(size) {
  if (warned)
    return;
  if (_optionalChain([getModelName, 'call', _3 => _3(), 'optionalAccess', _4 => _4.toLowerCase, 'call', _5 => _5(), 'access', _6 => _6.includes, 'call', _7 => _7("gpt-4o")])) {
...
async function markupImageForLLM(screenshotBase64, tree, size) {
  const elementsInfo = _extractor.treeToList.call(void 0, tree);
  ...
  const imagePayload = await _img.compositeElementInfoImg.call(void 0, {
...
function buildYamlFlowFromPlans(plans, sleep) {
  ...
  for (const plan2 of plans) {
    ...
    const locate = _optionalChain([plan2, 'access', _8 => _8.locate, 'optionalAccess', _9 => _9.prompt]);
    if (type === "Tap") {
      flow.push({
        aiTap: locate
      });
...
- Use ${_env.getPreferredLanguage.call(void 0, )} in \`thought\` part.
...
function initDebugConfig() {
  ...
  const shouldPrintAIResponse = _env.getAIConfigInBoolean.call(void 0, 
    _env.MIDSCENE_DEBUG_AI_RESPONSE
  );
...
Please check your config.`
  ...
  if (openai && _env.getAIConfigInBoolean.call(void 0, _env.MIDSCENE_LANGSMITH_DEBUG)) {
...
function safeParseJson(input) {
  ...
  try {
    return JSON.parse(_jsonrepair.jsonrepair.call(void 0, cleanJsonString));
  } catch (e) {
  }
  if (_env.vlLocateMode.call(void 0, ) === "doubao-vision" || _env.vlLocateMode.call(void 0, ) === "vlm-ui-tars") {
    const jsonString = preprocessDoubaoBboxJson(cleanJsonString);
    return JSON.parse(_jsonrepair.jsonrepair.call(void 0, jsonString));
  }
...
async function AiLocateElement(options) {
  ...
  } else if (_env.vlLocateMode.call(void 0, ) === "qwen-vl") {
    imagePayload = await _img.paddingToMatchBlockByBase64.call(void 0, imagePayload);
  } else if (!_env.vlLocateMode.call(void 0, )) {
...
async function plan(userInstruction, opts) {
  ...
  const userInstructionPrompt = await automationUserPrompt(
    _env.vlLocateMode.call(void 0, )
  ).format({
    pageDescription,
    taskBackgroundContext: taskBackgroundContextText
  });
  let imagePayload = screenshotBase64;
  if (_env.vlLocateMode.call(void 0, ) === "qwen-vl") {
    imagePayload = await _img.paddingToMatchBlockByBase64.call(void 0, imagePayload);
  } else if (!_env.vlLocateMode.call(void 0, )) {
    imagePayload = await markupImageForLLM(
      screenshotBase64,
...
function getUiTarsPlanningPrompt() {
  const preferredLanguage = _env.getPreferredLanguage.call(void 0, );
  return `
...
async function vlmPlanning(options) {
  ...
  const modelVer = _env.uiTarsModelVersion.call(void 0, );
...
async function resizeImageForUiTars(imageBase64, size) {
  if (_env.vlLocateMode.call(void 0, ) === "vlm-ui-tars" && _env.uiTarsModelVersion.call(void 0, ) === _env.UITarsModelVersion.V1_5) {
    ...
    if (currentPixels > maxPixels) {
      ...
      const resizedImage = await _img.resizeImgBase64.call(void 0, imageBase64, {
        width: newWidth,
        height: newHeight
      });
      return resizedImage;
