...
async function resizeImg(inputData, newSize) {
  ...
  const resizedBuffer = Buffer2.from(outputBytes);
  inputImage.free();
  outputImage.free();
...
var localImg2Base64 = (imgPath, withoutHeader = false) => {
  ...
  const type = path3.extname(imgPath).slice(1);
