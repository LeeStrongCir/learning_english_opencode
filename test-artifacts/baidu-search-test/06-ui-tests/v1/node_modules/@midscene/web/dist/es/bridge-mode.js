  ...
  async listen(opts = {}) {
    ...
    return new Promise((resolve2, reject) => {
      ...
      this.connectionTipTimer = !timeout || timeout > 3e3 ? setTimeout(() => {
        logMsg2("waiting for bridge to connect...");
      }, 2e3) : null;
  ...
  async call(method, args, timeout = BridgeCallTimeout) {
    ...
    return new Promise((resolve2, reject) => {
      const timeoutId = setTimeout(() => {
        logMsg2(`bridge call timeout, id=${id}, method=${method}, args=`, args);
...
var getBridgePageInCliSide = (timeout, closeConflictServer) => {
  ...
  return new Proxy(page, {
    get(target, prop, receiver) {
      assert8(typeof prop === "string", "prop must be a string");
      if (prop === "toJSON") {
        return () => {
          return {
