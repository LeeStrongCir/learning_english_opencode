...
var getHtmlElementScript = async () => {
  ...
  if (import_utils2.ifInBrowser || import_utils2.ifInWorker) {
...
var ExtensionBridgePageBrowserSide = class extends ChromeExtensionProxyPage {
  ...
  async setupBridgeClient() {
    ...
    this.onLogMessage(
      `Bridge connected, cli-side version v${this.bridgeClient.serverVersion}, browser-side version v${"0.25.3"}`,
      "log"
    );
  }
  async connect() {
