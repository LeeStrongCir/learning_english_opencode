...
__export(bridge_mode_exports, {
  ...
  allConfigFromEnv: () => import_env5.allConfigFromEnv,
  ...
  async listen(opts = {}) {
    ...
    return new Promise((resolve2, reject) => {
      ...
      this.connectionTipTimer = !timeout || timeout > 3e3 ? setTimeout(() => {
        (0, import_utils18.logMsg)("waiting for bridge to connect...");
      }, 2e3) : null;
      ...
      this.io.on("connection", (socket) => {
        ...
        try {
          (0, import_utils18.logMsg)("one client connected");
          this.socket = socket;
          const clientVersion = socket.handshake.query.version;
          (0, import_utils18.logMsg)(
            `Bridge connected, cli-side version v${"0.25.3"}, browser-side version v${clientVersion}`
          );
  ...
  async call(method, args, timeout = BridgeCallTimeout) {
    ...
    return new Promise((resolve2, reject) => {
      const timeoutId = setTimeout(() => {
        (0, import_utils18.logMsg)(`bridge call timeout, id=${id}, method=${method}, args=`, args);
...
var getBridgePageInCliSide = (timeout, closeConflictServer) => {
  ...
  return new Proxy(page, {
    get(target, prop, receiver) {
      (0, import_utils19.assert)(typeof prop === "string", "prop must be a string");
      if (prop === "toJSON") {
        return () => {
          return {
