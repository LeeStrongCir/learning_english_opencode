...
__export(chrome_extension_exports, {
  ...
  overrideAIConfig: () => import_env5.overrideAIConfig
});
...
var TaskCache = class {
  ...
  constructor(cacheId, isCacheResultUsed, cacheFilePath) {
    ...
    if (Buffer.byteLength(safeCacheId, "utf8") > cacheMaxFilenameLength) {
      ...
      const hash = (0, import_utils2.generateHashId)(void 0, safeCacheId);
      safeCacheId = `${prefix}-${hash}`;
    }
    this.cacheId = safeCacheId;
    this.cacheFilePath = import_utils.ifInBrowser || import_utils.ifInWorker ? void 0 : cacheFilePath || (0, import_node_path.join)((0, import_common.getMidsceneRunSubDir)("cache"), `${this.cacheId}${cacheFileExt}`);
...
cache file: ${cacheFile}`
  ...
  flushCacheToFile() {
    ...
    try {
      ...
      const yamlData = import_js_yaml.default.dump(cacheToWrite);
...
async function parseContextFromWebPage(page, _opt) {
  (0, import_utils5.assert)(page, "page is required");
  ...
  (0, import_utils5.assert)(screenshotBase64, "screenshotBase64 is required");
...
function getReportFileName(tag = "web") {
  ...
  const uniqueId = (0, import_utils5.uuid)().substring(0, 8);
  return `${reportTagName || tag}-${dateTimeInFileName}-${uniqueId}`;
}
function printReportMsg(filepath) {
  (0, import_utils5.logMsg)(`Midscene - report file updated: ${filepath}`);
}
...
var ScriptPlayer = class {
  constructor(script, setupAgent, onTaskStatusChange, scriptPath) {
    ...
    if (import_utils6.ifInBrowser || import_utils6.ifInWorker) {
      this.output = void 0;
    } else if (this.target?.output) {
      this.output = (0, import_node_path2.resolve)(process.cwd(), this.target.output);
    } else {
      const scriptName = this.scriptPath ? (0, import_node_path2.basename)(this.scriptPath, ".yaml").replace(/\.(ya?ml)$/i, "") : "script";
      this.output = (0, import_node_path2.join)(
  ...
  async playTask(taskStatus, agent) {
    ...
    (0, import_utils6.assert)(flow, "missing flow in task");
    for (const flowItemIndex in flow) {
      ...
      if ("aiAction" in flowItem || "ai" in flowItem) {
        ...
        (0, import_utils6.assert)(prompt, "missing prompt for ai (aiAction)");
        ...
        (0, import_utils6.assert)(prompt, "missing prompt for aiAssert");
        (0, import_utils6.assert)(
          typeof prompt === "string",
        ...
        (0, import_utils6.assert)(prompt, "missing prompt for aiQuery");
        (0, import_utils6.assert)(
          typeof prompt === "string",
        ...
        (0, import_utils6.assert)(prompt, "missing prompt for aiNumber");
        (0, import_utils6.assert)(
          typeof prompt === "string",
        ...
        (0, import_utils6.assert)(prompt, "missing prompt for aiString");
        (0, import_utils6.assert)(
          typeof prompt === "string",
        ...
        (0, import_utils6.assert)(prompt, "missing prompt for aiBoolean");
        (0, import_utils6.assert)(
          typeof prompt === "string",
        ...
        (0, import_utils6.assert)(prompt, "missing prompt for aiAsk");
        (0, import_utils6.assert)(typeof prompt === "string", "prompt for aiAsk must be a string");
        ...
        (0, import_utils6.assert)(prompt, "missing prompt for aiLocate");
        (0, import_utils6.assert)(
          typeof prompt === "string",
        ...
        (0, import_utils6.assert)(prompt, "missing prompt for aiWaitFor");
        (0, import_utils6.assert)(
          typeof prompt === "string",
...
function parseYamlScript(content, filePath, ignoreCheckingTarget) {
  ...
  (0, import_utils7.assert)(obj.tasks, `property "tasks" is required in yaml script ${pathTip}`);
  (0, import_utils7.assert)(
...
keyDescriptionForString_fn = function(keyString) {
  ...
  (0, import_utils17.assert)(definition, `Unknown key: "${keyString}"`);
  if (definition.key) {
...
var getHtmlElementScript = async () => {
  ...
  if (import_utils18.ifInBrowser || import_utils18.ifInWorker) {
...
var ChromeExtensionProxyPage = class {
  constructor(forceSameTabNavigation) {
    ...
    this._continueWhenFailedToAttachDebugger = false;
  ...
  async attachDebugger() {
    (0, import_utils19.assert)(!this.destroyed, "Page is destroyed");
  ...
  async sendCommandToDebugger(command, params) {
    ...
    (0, import_utils19.assert)(this.tabIdOfDebuggerAttached, "Debugger is not attached");
