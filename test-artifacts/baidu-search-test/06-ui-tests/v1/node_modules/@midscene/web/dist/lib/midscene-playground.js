...
var setup = async () => {
  if (!import_utils21.ifInBrowser && !import_utils21.ifInWorker) {
    const { parsed } = import_dotenv.default.config();
    if (parsed) {
      (0, import_env5.overrideAIConfig)(parsed);
    }
  }
};
var PlaygroundServer = class {
  constructor(pageClass, agentClass, staticPath) {
    ...
    this.tmpDir = (0, import_utils20.getTmpDir)();
  ...
  async launch(port) {
    ...
    this.app.post(
      ...
      async (req, res) => {
        ...
        try {
          (0, import_env5.overrideAIConfig)(aiConfig);
          return res.json({
            status: "ok",
