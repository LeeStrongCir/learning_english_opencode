...
var MidsceneReporter = class _MidsceneReporter {
  constructor(options = {}) {
    this.testTitleToFilename = /* @__PURE__ */ new Map();
    this.mode = _MidsceneReporter.getMode(options.type ?? "merged");
  }
  ...
  updateReport(testData) {
    ...
    const reportPath = (0, import_utils7.writeDumpReport)(
      fileName,
      testData,
      this.mode === "merged"
    );
