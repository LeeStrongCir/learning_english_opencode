...
var import_utils20 = require("@midscene/shared/utils");
...
var debug6 = (0, import_logger7.getDebug)("puppeteer:agent");
...
var launcherDebug = (0, import_logger8.getDebug)("puppeteer:launcher");
async function launchPuppeteerPage(target, preference, browser) {
  (0, import_utils20.assert)(target.url, "url is required");
  const freeFn = [];
  ...
  if (target.viewportScale) {
    ...
    (0, import_utils20.assert)(dpr > 0, `viewportScale must be greater than 0, but got ${dpr}`);
  }
  ...
  if (!browserInstance) {
    browserInstance = await import_puppeteer2.default.launch({
